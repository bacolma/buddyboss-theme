...
final class Icon_Picker {
	...
	protected function __construct( $args = array() ) {
		...
		$buddyboss_menu_icons = buddyboss_menu_icons();

		$defaults = array(
			'dir' => $buddyboss_menu_icons->public_data['dir'] . 'vendor/kucrut/icon-picker/',
			'url' => $buddyboss_menu_icons->public_data['url'] . 'vendor/kucrut/icon-picker/',
		);
