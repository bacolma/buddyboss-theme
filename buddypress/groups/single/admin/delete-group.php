...
<h2 class="bp-screen-title warn">
	<?php esc_html_e( 'Delete this group', 'buddyboss-theme' ); ?>
</h2>
...
<div>
	...
	<label for="delete-group-understand" class="bp-label-text warn"><?php esc_html_e( 'I understand the consequences of deleting this group.', 'buddyboss-theme' ); ?></label>
</div>
...
<?php if ( bp_is_active('forums') && bbp_get_group_forum_ids( groups_get_current_group()->id ) ): ?>
	<div>
		...
		<label for="delete-group-forum-understand"><?php esc_html_e( 'I also want to delete the discussion forum.', 'buddyboss-theme' ); ?></label>
	</div>
<?php endif; ?>
